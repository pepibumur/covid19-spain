...
#### Datos actualizados a fecha de 19 de Abril
...
<Message title="Nota" description={`Aunque como ciudadano tu obligación es cumplir con las medias impuestas por el estado, **estás en el derecho de tener acceso a información rigurosa** que va más allá de hablar en términos de picos y curvas. Confiamos en que las decisiones del gobierno están respaldadas por rigorósos análisis a los que desafortunadamente no tenemos acceso. Mas allá de fallecimientos e infecciones, el gobierno cuenta con variables que van más allá de la salud de sus ciudadanos, como lo son la economía o la política.`}/>

## Datos

### Tasa de reproducción efectiva por provincia

Las siguientes gráficas muestran la evolución de la tasa de reproducción del virus por provincia. Como se trata de una estimación, los gráficos muestran una zona gris que engloba los rangos entre los cuales podría oscilar.

![Gráficos por región que muestran la evolución de la tasa de reproducción del virus en el tiempo](../src/images/provinces.png)

### Provincias ordenadas en función de su tasa

El siguiente gráfico organiza las provincias en función de la tasa de reproduccion del virus a fecha del 19 de Abril. En aquellas provincias situadas a la izquierda, es decir con una tasa de reproducción inferior, el virus está más controlado que en aquellas que aparecen a la derecha del gráfico.
