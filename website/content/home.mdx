...
El gráfico organiza las comunicades autónomas en función de la tasa de reproduccion del virus a fecha del 19 de Abril. En aquellas comunidades situadas a la izquierda, es decir con una tasa de reproducción inferior, el virus está más controlado que en aquellas que aparecen a la derecha del gráfico.
